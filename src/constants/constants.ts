...
export const MIN_DISTRIBUTE_AMOUNT = Number(retrieveEnvVariable('MIN_DISTRIBUTE_AMOUNT', logger));
export const MAX_DISTRIBUTE_AMOUNT = Number(retrieveEnvVariable('MAX_DISTRIBUTE_AMOUNT', logger));
